...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(KorisnickiEmailZauzetException.class)
    public final ResponseEntity<ErrorEntity> handleEmailKorisnikException (KorisnickiEmailZauzetException e) {
    ...
    @ExceptionHandler(NeuspesnaPrijavaException.class)
    public final ResponseEntity<ErrorEntity> handlePrijavaException (NeuspesnaPrijavaException e) {
        ErrorEntity errorEntity = new ErrorEntity(e.getMessage(), LocalDateTime.now());
        return new ResponseEntity<>(errorEntity, HttpStatus.NOT_FOUND);
    }
